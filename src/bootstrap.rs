...
use kube::Client;
use k8s_openapi::api::admissionregistration::v1::{ValidatingWebhookConfiguration, ValidatingWebhook};
...
use crate::operator;
use crate::crd::{WebhookHelper, HelperSpec};
...
pub async fn bootstrap(namespace: String) -> Result<(), Error> {
    ...
    operator::bootstrap::bootstrap(client.clone(), WebhookHelper { 
        metadata: ObjectMeta{
